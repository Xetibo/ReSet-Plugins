...
pub fn apply_monitor_configuration(monitors: &Vec<Monitor>, wlr_objects_vec: &Vec<HashMap<u32,ObjectId>>) {
    match get_environment().as_str() {
        // "Hyprland" => hy_apply_monitor_information(monitors),
        "Hyprland" => wlr_apply_monitor_configuration(monitors, wlr_objects_vec),
